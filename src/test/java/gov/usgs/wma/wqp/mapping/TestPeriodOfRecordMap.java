...
import static gov.usgs.wma.wqp.mapping.BaseColumn.KEY_ACTIVITY_COUNT;
...
import static gov.usgs.wma.wqp.mapping.BaseColumn.KEY_RESULT_COUNT;
...
import static gov.usgs.wma.wqp.mapping.StationColumn.KEY_LAST_SUBMITTED_DATE;
...
import static gov.usgs.wma.wqp.mapping.StationColumn.KEY_PERIOD_OF_RECORD;
...
public class TestPeriodOfRecordMap {
	...
	static {
		...
		PERIOD_OF_RECORD_ONE_YEAR.put(KEY_ORGANIZATION_NAME, "organization name");
	...
	static {
		...
		PERIOD_OF_RECORD_FIVE_YEARS.put(KEY_ORGANIZATION_NAME, "organization name");
	...
	static {
		...
		PERIOD_OF_RECORD_ALL_YEARS.put(KEY_ORGANIZATION_NAME, "organization name");
