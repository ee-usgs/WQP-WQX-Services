...
import static gov.usgs.wma.wqp.mapping.BaseColumn.KEY_DATA_SOURCE;
import static gov.usgs.wma.wqp.mapping.BaseColumn.KEY_DATA_SOURCE_ID;
...
import static gov.usgs.wma.wqp.mapping.StationColumn.KEY_CHARACTERISTIC_NAME;
import static gov.usgs.wma.wqp.mapping.StationColumn.KEY_CHARACTERISTIC_TYPE;
import static gov.usgs.wma.wqp.mapping.StationColumn.KEY_COUNTY_NAME;
import static gov.usgs.wma.wqp.mapping.StationColumn.KEY_HUC_8;
import static gov.usgs.wma.wqp.mapping.StationColumn.KEY_LAST_RESULT_DATE;
import static gov.usgs.wma.wqp.mapping.StationColumn.KEY_LATITUDE;
import static gov.usgs.wma.wqp.mapping.StationColumn.KEY_LONGITUDE;
import static gov.usgs.wma.wqp.mapping.StationColumn.KEY_MONITORING_LOCATION_TYPE_NAME;
import static gov.usgs.wma.wqp.mapping.StationColumn.KEY_MONITORING_LOCATION_URL;
import static gov.usgs.wma.wqp.mapping.StationColumn.KEY_SITE_TYPE;
import static gov.usgs.wma.wqp.mapping.StationColumn.KEY_STATE_NAME;
import static gov.usgs.wma.wqp.mapping.StationColumn.KEY_STATION_NAME;
import static gov.usgs.wma.wqp.mapping.StationColumn.KEY_THE_YEAR;
import static gov.usgs.wma.wqp.mapping.StationColumn.KEY_TOTAL_ACTIVITIES;
import static gov.usgs.wma.wqp.mapping.StationColumn.KEY_TOTAL_RESULTS;
...
public class TestPeriodOfRecordCSVMap {	
	...
	static {
		...
		STEWARDS_36_2000.put(KEY_MONITORING_LOCATION_URL, "http://siteUrlBase/provider/STEWARDS/ARS/ARS-IAWC-IAWC225");
	...
	static {
		...
		STORET_504707_1910.put(KEY_MONITORING_LOCATION_URL, "http://siteUrlBase/provider/STORET/21NYDECA_WQX/21NYDECA_WQX-ONTARIO-02");
	...
	static {
		...
		NWIS_1353690_2017.put(KEY_MONITORING_LOCATION_URL, "http://siteUrlBase/provider/NWIS/USGS-WI/USGS-05425700");
	...
	static {
		...
		NWIS_1353690_2018.put(KEY_MONITORING_LOCATION_URL, "http://siteUrlBase/provider/NWIS/USGS-WI/USGS-05425700");
	...
	static {
		...
		NWIS_1360035_2017.put(KEY_MONITORING_LOCATION_URL, "http://siteUrlBase/provider/NWIS/USGS-WI/USGS-431925089002701");
	...
	static {
		...
		NWIS_1360035_2018.put(KEY_MONITORING_LOCATION_URL, "http://siteUrlBase/provider/NWIS/USGS-WI/USGS-431925089002701");
