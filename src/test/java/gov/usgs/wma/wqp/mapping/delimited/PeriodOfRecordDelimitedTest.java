...
import gov.usgs.wma.wqp.mapping.xml.BaseWqx;
...
public class PeriodOfRecordDelimitedTest {
	...
	public static void assertPeriodOfRecordProfile(Map<String, String> mapping) {
		...
		assertEquals(PeriodOfRecordDelimited.VALUE_MONITORING_LOCATION_IDENTIFIER, mapping.get(keys[1]));
		...
		assertEquals(BaseWqx.WQX_MONITORING_LOCATION_NAME, mapping.get(keys[10]));
		assertEquals(PeriodOfRecordDelimited.VALUE_MONITORING_LOCATION_NAME, mapping.get(keys[10]));		
		assertEquals(BaseWqx.WQX_MONITORING_LOCATION_TYPE, mapping.get(keys[11]));		
		assertEquals(PeriodOfRecordDelimited.VALUE_MONITORING_LOCATION_TYPE_NAME, mapping.get(keys[11]));
		assertEquals(BaseWqx.WQX_RESOLVED_MONITORING_LOCATION, mapping.get(keys[12]));		
		assertEquals(PeriodOfRecordDelimited.VALUE_RESOLVED_MONITORING_LOCATION, mapping.get(keys[12]));
		assertEquals(BaseWqx.WQX_HUC_8, mapping.get(keys[13]));
		assertEquals(PeriodOfRecordDelimited.VALUE_HUC_8, mapping.get(keys[13]));		
		assertEquals(BaseWqx.WQX_MONITORING_LOCATION_URL, mapping.get(keys[14]));
		assertEquals(PeriodOfRecordDelimited.VALUE_MONITORING_LOCATION_URL, mapping.get(keys[14]));
		assertEquals(BaseWqx.WQX_COUNTY_NAME, mapping.get(keys[15]));
		assertEquals(PeriodOfRecordDelimited.VALUE_COUNTY_NAME, mapping.get(keys[15]));
		assertEquals(BaseWqx.WQX_STATE_NAME, mapping.get(keys[16]));
		assertEquals(PeriodOfRecordDelimited.VALUE_STATE_NAME, mapping.get(keys[16]));
		assertEquals(BaseWqx.WQX_MONITORING_LOCATION_LATITUDE, mapping.get(keys[17]));
		assertEquals(PeriodOfRecordDelimited.VALUE_MONITORING_LOCATION_LATITUDE, mapping.get(keys[17]));
		assertEquals(BaseWqx.WQX_MONITORING_LOCATION_LONGITUDE, mapping.get(keys[18]));
		assertEquals(PeriodOfRecordDelimited.VALUE_MONITORING_LOCATION_LONGITUDE, mapping.get(keys[18]));		
	}	
}
