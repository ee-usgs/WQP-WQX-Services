...
import static gov.usgs.wma.wqp.mapping.BaseColumn.KEY_LAST_UPDATED;
import static gov.usgs.wma.wqp.mapping.ProjectColumn.KEY_PROJECT_NAME;
import static gov.usgs.wma.wqp.mapping.ResultColumn.*;
import static gov.usgs.wma.wqp.mapping.StationColumn.KEY_STATION_NAME;
import static gov.usgs.wma.wqp.mapping.TestResDetectQntLmtMap.BASE_RES_DETECT_QNT_LMT;
import static gov.usgs.wma.wqp.mapping.TestStationMap.BASE_STATION;
import static gov.usgs.wma.wqp.mapping.TestActivityMap.*;
import static gov.usgs.wma.wqp.mapping.TestLabSamplePrepMap.BASE_LAB_SAMPLE_PREP;
import static gov.usgs.wma.wqp.mapping.TestFreqClassInfoMap.BASE_FREQ_CLASS_INFO;
