...
import static gov.usgs.wma.wqp.mapping.xml.StationKml.*;
import static gov.usgs.wma.wqp.openapi.model.StationCountJson.*;
import static gov.usgs.wma.wqp.mapping.TestOrganizationMap.BASE_ORGANIZATION;
