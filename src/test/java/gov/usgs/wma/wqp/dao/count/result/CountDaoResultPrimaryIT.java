package gov.usgs.wma.wqp.dao.count.result;
...
import gov.usgs.wma.wqp.dao.count.BaseCountDaoTest;
...
public class CountDaoResultPrimaryIT extends BaseCountDaoTest {

	protected NameSpace nameSpace = NameSpace.RESULT_PRIMARY;
