...
import gov.usgs.wma.wqp.dao.FilteredResDetectQntLmtDaoTest;
...
import gov.usgs.wma.wqp.mapping.TestResDetectQntLmtMap;
...
public class ResDetectQntLmtStreamingIT extends FilteredResDetectQntLmtDaoTest {
	...
	public void assertContainsResDetectQntLmt(List<Map<String, Object>> results, String[]...  resDetectQntLmt) {
		...
		assertEquals(results.size(), resDetectQntLmt.length, "Double check expected size");
	}
