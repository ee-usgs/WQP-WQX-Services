...
import gov.usgs.wma.wqp.dao.streaming.BaseStationStreamingTest;
import gov.usgs.wma.wqp.mapping.TestSummaryMonitoringLocationMap;
...
public class SummaryMonitoringLocationStreamingIT extends BaseStationStreamingTest {
	...
	public void bboxTest(NameSpace nameSpace) {
		...
		assertContainsStation(results, STEWARDS_36, STEWARDS_46, NWIS_1353690, NWIS_1360035,
				STORET_777, STORET_888, STORET_1383, STORET_1043441);
	}
	...
	public void countryTest(NameSpace nameSpace) {
		...
		assertContainsStation(results, STEWARDS_36, STEWARDS_46, NWIS_1353690, NWIS_1360035,
				NWIS_61233184, STORET_777, STORET_888, STORET_999, STORET_1383, STORET_1043441);
	}
	...
	public void emptyParameterTest(NameSpace nameSpace) {
		...
		assertContainsStation(results, STEWARDS_36, STEWARDS_46, NWIS_1353690, NWIS_1360035,
				NWIS_61233184, STORET_777, STORET_888, STORET_999,
				STORET_1383, STORET_504707, STORET_1043441);
	}
	...
	public void organizationTest(NameSpace nameSpace) {
		...
		assertContainsStation(results, STEWARDS_36, STEWARDS_46, NWIS_1353690, NWIS_1360035,
				STORET_777, STORET_888, STORET_999, STORET_1383,
				STORET_1043441);
	}

	@Override
	public void providersTest(NameSpace nameSpace) {
		List<Map<String, Object>> results = providersTest(nameSpace, 9);
		assertContainsStation(results,NWIS_1353690, NWIS_1360035, NWIS_61233184,
				STORET_777, STORET_888, STORET_999,
				STORET_1383, STORET_504707, STORET_1043441);
	}
	...
	public void siteIdTest(NameSpace nameSpace) {
		...
		assertContainsStation(results, STEWARDS_36, STEWARDS_46, NWIS_1353690, NWIS_1360035,
				STORET_777, STORET_888, STORET_999, STORET_1043441);
	}

	@Override
	public void siteTypeTest(NameSpace nameSpace) {
		List<Map<String, Object>> results = siteTypeTest(nameSpace, 10);
		assertContainsStation(results, STEWARDS_36, STEWARDS_46, NWIS_1353690, NWIS_61233184,
				STORET_777, STORET_888, STORET_999, STORET_1383,
	...
	public void sortedAllSummaryTest(NameSpace nameSpace) {
		...
		assertRow(results.get(3), NWIS_1353690, expectedColumnCount);
		assertRow(results.get(4), NWIS_1360035, expectedColumnCount);
		assertRow(results.get(5), STORET_1043441, expectedColumnCount);
		assertRow(results.get(6), STORET_504707, expectedColumnCount);
		assertRow(results.get(7), STORET_1383, expectedColumnCount);
		assertStoret888(expectedMapAllYears, results.get(8));
	...
	public void sortedFiveYearsSummaryTest(NameSpace nameSpace) {
		...
		assertRow(results.get(6), STORET_504707, expectedColumnCount);
		assertRow(results.get(7), STORET_1383, expectedColumnCount);
		assertStoret888(expectedMapFiveYears, results.get(8));
	...
	public void sortedOneYearSummaryTest(NameSpace nameSpace) {
		...
		assertRow(results.get(6), STORET_504707, expectedColumnCount);
		assertRow(results.get(7), STORET_1383, expectedColumnCount);
		assertStoret888(expectedMapOneYear, results.get(8));
	}
