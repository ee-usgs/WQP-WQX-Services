...
public abstract class BaseSpringTest {
	...
	public static String TOTAL_PROJECT_COUNT = "11";
	public static String TOTAL_PROJECT_COUNT_MINUS_2 = "9";
	public static String NWIS_PROJECT_COUNT = "2";
	public static String NWIS_PROJECT_COUNT_MINUS_1 = "1";
	public static String STEWARDS_PROJECT_COUNT = "1";
	public static String STORET_PROJECT_COUNT = "7";
	public static String STORET_PROJECT_COUNT_MINUS_1 = "6";
