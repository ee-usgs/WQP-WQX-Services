...
public class RegexValidatorTest extends BaseSpringTest implements ValidationConstants {
    ...
    public void testConstructors() {
        ...
        validator = new RegexValidator<Object>(Parameters.ACTIVITY_ID, 5, 12, "!", "[0-9]+|abc");
        ...
        validator = new RegexValidator<Object>(Parameters.ACTIVITY_ID, 1, 1, null, "[0-9]+|abc");
    ...
    @Test
    public void testValidate_SimpleLiteral() {
    ...
    @Test
    public void testValidate_SimpleNumeric() {
    ...
    @Test
    public void testValidate_MinOccursOnce() {
        ...
        vr = validator.validate("abc");
        assertTrue(vr.isValid());
        assertEquals(0, vr.getValidationMessages().size());
        assertArrayEquals(new String[]{"abc"}, vr.getTransformedValue());
        
        vr = validator.validate("abcabc");
        assertFalse(vr.isValid());
        assertEquals(1, vr.getValidationMessages().size());
    ...
    public void testValidate_MaxOccursThrice() {
        ...
        vr = validator.validate("abc" + delim + "abc");
        assertTrue(vr.isValid());
        assertEquals(0, vr.getValidationMessages().size());
        assertArrayEquals(new String[]{"abc", "abc"}, vr.getTransformedValue());

        vr = validator.validate("abc" + delim + "abc" + delim + "abc");
        assertTrue(vr.isValid());
        assertEquals(0, vr.getValidationMessages().size());
        assertArrayEquals(new String[]{"abc", "abc", "abc"}, vr.getTransformedValue());

        vr = validator.validate("abc" + delim + "abc" + delim + "abc" + delim + "abc");
        assertFalse(vr.isValid());
        assertEquals(1, vr.getValidationMessages().size());
    ...
    public void testCounty() throws Exception {
        ...
        vr = validator.validate("US:55:027;CV");
        assertFalse(vr.isValid());
        assertEquals(1, vr.getValidationMessages().size());
    ...
    public void testHuc() {
        ...
        vr = validator.validate("07090002;CV");
        assertFalse(vr.isValid());
        assertEquals(1, vr.getValidationMessages().size());
    ...
    public void testSiteId() {
        ...
        vr = validator.validate("CV;IASF-IATC201");
        assertFalse(vr.isValid());
        assertEquals(1, vr.getValidationMessages().size());
    ...
    public void testState() {
        ...
        vr = validator.validate("US:55;CV");
        assertFalse(vr.isValid());
        assertEquals(1, vr.getValidationMessages().size());
