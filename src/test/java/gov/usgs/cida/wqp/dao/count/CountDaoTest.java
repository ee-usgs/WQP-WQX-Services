...
public abstract class CountDaoTest extends BaseSpringTest {
	...
	public void nullParameterTest(String namespace, boolean includeActivity, boolean includeResults) {
	...
	public void emptyParameterTest(String namespace, boolean includeActivity, boolean includeResults) {
	...
	public void avoidTest(String namespace, boolean includeActivity, boolean includeResults) {
	...
	public void bboxTest(String namespace, boolean includeActivity, boolean includeResults) {
	...
	public void countryTest(String namespace, boolean includeActivity, boolean includeResults) {
	...
	public void countyTest(String namespace, boolean includeActivity, boolean includeResults) {
	...
	public void huc2Test(String namespace, boolean includeActivity, boolean includeResults) {
	...
	public void huc4Test(String namespace, boolean includeActivity, boolean includeResults) {
	...
	public void huc6Test(String namespace, boolean includeActivity, boolean includeResults) {
	...
	public void huc8Test(String namespace, boolean includeActivity, boolean includeResults) {
	...
	public void minActivitiesTest(String namespace, boolean includeActivity, boolean includeResults) {
		parms.put(Parameters.MIN_ACTIVITIES.toString(), getMinActivities());
		counts = countDao.getCounts(namespace, parms);
		assertStationResults(counts, 4, "7", "1", "1", "5", null);
		if (includeActivity) {
			assertActivityResults(counts, 4, "20", "2", "2", "16", null);
		}
		if (includeResults) {
	...
	public void minResultsTest(String namespace, boolean includeActivity, boolean includeResults) {
		parms.put(Parameters.MIN_RESULTS.toString(), getMinResults());
		counts = countDao.getCounts(namespace, parms);
		assertStationResults(counts, 3, "6", "1", null, "5", null);
		if (includeActivity) {
			assertActivityResults(counts, 3, "18", "2", null, "16", null);
		}
		if (includeResults) {
	...
	public void nldiUrlTest(String namespace, boolean includeActivity, boolean includeResults) {
		try {
			parms.put(Parameters.NLDIURL.toString(), getManySiteId());
			counts = countDao.getCounts(namespace, parms);
			assertStationResults(counts, 2, "3", null, null, "3", null);
			if (includeActivity) {
				assertActivityResults(counts, 2, "9", null, null, "9", null);
			}
			if (includeResults) {
	...
	public void organizationTest(String namespace, boolean includeActivity, boolean includeResults) {
	...
	public void providersTest(String namespace, boolean includeActivity, boolean includeResults) {
	...
	public void siteIdTest(String namespace, boolean includeActivity, boolean includeResults) {
	...
	public void manySitesTest(String namespace, boolean includeActivity, boolean includeResults) {
		try {
	...
	public void siteTypeTest(String namespace, boolean includeActivity, boolean includeResults) {
	...
	public void stateTest(String namespace, boolean includeActivity, boolean includeResults) {
	...
	public void withinTest(String namespace, boolean includeActivity, boolean includeResults) {
	...
	public void projectTest(String namespace, boolean includeActivity, boolean includeResults) {
	...
	public void sampleMediaTest(String namespace, boolean includeActivity, boolean includeResults) {
	...
	public void startDateHiTest(String namespace, boolean includeActivity, boolean includeResults) {
	...
	public void startDateLoTest(String namespace, boolean includeActivity, boolean includeResults) {
	...
	public void analyticalMethodTest(String namespace, boolean includeActivity, boolean includeResults) {
	...
	public void assemblageTest(String namespace, boolean includeActivity, boolean includeResults) {
	...
	public void characteristicNameTest(String namespace, boolean includeActivity, boolean includeResults) {
	...
	public void characteristicTypeTest(String namespace, boolean includeActivity, boolean includeResults) {
	...
	public void pcodeTest(String namespace, boolean includeActivity, boolean includeResults) {
	...
	public void subjectTaxonomicNameTest(String namespace, boolean includeActivity, boolean includeResults) {
	...
	public void multipleParameterStationSumTest(String namespace, boolean includeActivity, boolean includeResults) {
		parms.put(Parameters.AVOID.toString().replace(".", ""), getAvoid());
		parms.put(Parameters.BBOX.toString(), getBBox());
		parms.put(Parameters.COUNTRY.toString(), getCountry());
		parms.put(Parameters.COUNTY.toString(), getCounty());
	...
	public void multipleParameterActivitySumTest(String namespace, boolean includeActivity, boolean includeResults) {
		parms.put(Parameters.AVOID.toString().replace(".", ""), getAvoid());
		parms.put(Parameters.MIN_ACTIVITIES.toString(), getMinActivities());
		parms.put(Parameters.MIN_RESULTS.toString(), getMinResults());
		parms.put(Parameters.PROJECT.toString(), getProject());
	...
	public void multipleParameterActivitySumStationSumTest(String namespace, boolean includeActivity, boolean includeResults) {
		parms.put(Parameters.AVOID.toString().replace(".", ""), getAvoid());
		parms.put(Parameters.BBOX.toString(), getBBox());
		parms.put(Parameters.LATITUDE.toString(), getLatitude());
		parms.put(Parameters.LONGITUDE.toString(), getLongitude());
	...
	public void multipleParameterResultSumTest(String namespace, boolean includeActivity, boolean includeResults) {
		parms.put(Parameters.ANALYTICAL_METHOD.toString(), getAnalyticalMethod());
		parms.put(Parameters.AVOID.toString().replace(".", ""), getAvoid());
		parms.put(Parameters.ASSEMBLAGE.toString(), getAssemblage());
		parms.put(Parameters.CHARACTERISTIC_NAME.toString(), getCharacteristicName());
	...
	public void multipleParameterResultSumStationSumTests(String namespace, boolean includeActivity, boolean includeResults) {
		parms.clear();
		parms.put(Parameters.ANALYTICAL_METHOD.toString(), getAnalyticalMethod());
		parms.put(Parameters.AVOID.toString().replace(".", ""), getAvoid());
		parms.put(Parameters.ASSEMBLAGE.toString(), getAssemblage());
