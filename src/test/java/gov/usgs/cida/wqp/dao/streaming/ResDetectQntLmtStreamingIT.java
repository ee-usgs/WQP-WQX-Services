...
public class ResDetectQntLmtStreamingIT extends FilteredResDetectQntLmtDaoTest {
	...
	public void sortedTest() {
		...
		assertStoret("72", results.get(46));
		assertStoret("73", results.get(47));
		assertStoret("70", results.get(48));
		assertStoret("71", results.get(49));
		assertStoret("24", results.get(50));
		assertStoret("25", results.get(51));
		assertStoret("26", results.get(52));
		assertStoret("27", results.get(53));
		assertStoret("17", results.get(54));
		assertStoret("18", results.get(55));
		assertStoret("19", results.get(56));
		assertStoret("23", results.get(57));
		assertStoret("22", results.get(58));
		assertStoret("20", results.get(59));
		assertStoret("21", results.get(60));
		assertStoret("28", results.get(61));
		assertStoret39(results.get(62));
		assertStoret("29", results.get(63));
		assertStoret("31", results.get(64));
		assertStoret("32", results.get(65));
		assertStoret("34", results.get(66));
		assertStoret("36", results.get(67));
		assertStoret("37", results.get(68));
