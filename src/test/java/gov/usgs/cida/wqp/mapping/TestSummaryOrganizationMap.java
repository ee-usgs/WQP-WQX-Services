...
import static gov.usgs.cida.wqp.mapping.OrganizationColumn.KEY_ACTIVITY_COUNT;
...
public class TestSummaryOrganizationMap {
    ...
    static {
	SUMMARY_ORGANIZATION_CURRENT_YEAR = new LinkedHashMap<String, Object>();
	SUMMARY_ORGANIZATION_CURRENT_YEAR.put(KEY_ORGANIZATION_SUMMARY, VALUE_ORGANIZATION_SUMMARY_CURRENT_YEAR);
	SUMMARY_ORGANIZATION_CURRENT_YEAR.put(KEY_LAST_RESULT, "2003-10-02");	
    ...
    static {
	SUMMARY_ORGANIZATION_FIVE_YEAR = new LinkedHashMap<String, Object>();	
	SUMMARY_ORGANIZATION_FIVE_YEAR.put(KEY_ORGANIZATION_SUMMARY, VALUE_ORGANIZATION_SUMMARY_FIVE_YEAR);
	SUMMARY_ORGANIZATION_FIVE_YEAR.put(KEY_LAST_RESULT, "10-09-15");
	SUMMARY_ORGANIZATION_FIVE_YEAR.put(KEY_SITE_COUNT, BigDecimal.valueOf(5));
	SUMMARY_ORGANIZATION_FIVE_YEAR.put(KEY_ACTIVITY_COUNT, BigDecimal.valueOf(5));
	SUMMARY_ORGANIZATION_FIVE_YEAR.put(KEY_ORGANIZATION_ID, "organizationId_5");
	SUMMARY_ORGANIZATION_FIVE_YEAR.put(KEY_ORGANIZATION_DESCRIPTION, "organizationDesctiption_5");
	SUMMARY_ORGANIZATION_FIVE_YEAR.put(KEY_ORGANIZATION_SUMMARY_WQP_URL, "/provider/STORET/21FLSMRC_WQX_5");
    
    }
    
    public static final Map<String, Object> SUMMARY_ORGANIZATION_ALL_YEAR;
    static {
	SUMMARY_ORGANIZATION_ALL_YEAR = new LinkedHashMap<String, Object>();	
	SUMMARY_ORGANIZATION_ALL_YEAR.put(KEY_ORGANIZATION_SUMMARY, VALUE_ORGANIZATION_SUMMARY_ALL_YEAR);
	SUMMARY_ORGANIZATION_ALL_YEAR.put(KEY_LAST_RESULT, "11-07-99");
	SUMMARY_ORGANIZATION_ALL_YEAR.put(KEY_SITE_COUNT, BigDecimal.valueOf(100));
	SUMMARY_ORGANIZATION_ALL_YEAR.put(KEY_ACTIVITY_COUNT, BigDecimal.valueOf(100));
	SUMMARY_ORGANIZATION_ALL_YEAR.put(KEY_ORGANIZATION_ID, "organizationId_all");
	SUMMARY_ORGANIZATION_ALL_YEAR.put(KEY_ORGANIZATION_DESCRIPTION, "organizationDesctiption_all");
	SUMMARY_ORGANIZATION_ALL_YEAR.put(KEY_ORGANIZATION_SUMMARY_WQP_URL, "/provider/STORET/21FLSMRC_WQX");    
    }     
}
