...
public class TestSummaryOrganizationMap {
	...
	SUMMARY_ORGANIZATION_CURRENT_YEAR.put(KEY_LAST_RESULT, "10-09-15");
	SUMMARY_ORGANIZATION_CURRENT_YEAR.put(KEY_SITE_COUNT, BigDecimal.valueOf(5));
	SUMMARY_ORGANIZATION_CURRENT_YEAR.put(KEY_ACTIVITY_COUNT, BigDecimal.valueOf(5));
	...
	SUMMARY_ORGANIZATION_CURRENT_YEAR.put(KEY_LAST_RESULT, "11-07-99");
	SUMMARY_ORGANIZATION_CURRENT_YEAR.put(KEY_SITE_COUNT, BigDecimal.valueOf(100));
	SUMMARY_ORGANIZATION_CURRENT_YEAR.put(KEY_ACTIVITY_COUNT, BigDecimal.valueOf(100));
