...
public class TestSummaryStationMap {
	...
	static {
		SUMMARY_STATION_ONE_YEAR = new LinkedHashMap<>();
		...
		SUMMARY_STATION_ONE_YEAR.put(KEY_ORGANIZATION_NAME, "organization name");
		SUMMARY_STATION_ONE_YEAR.put(KEY_SITE_TYPE, "siteType");
		SUMMARY_STATION_ONE_YEAR.put(KEY_HUC_8, "00000000");
		SUMMARY_STATION_ONE_YEAR.put(KEY_MONITORING_LOCATION_TYPE, "River/Stream");
		SUMMARY_STATION_ONE_YEAR.put(KEY_LATITUDE, "43.3330000");
		SUMMARY_STATION_ONE_YEAR.put(KEY_LONGITUDE, "-89.8989000");
		SUMMARY_STATION_ONE_YEAR.put(KEY_ACTIVITY_COUNT, BigDecimal.valueOf(1));
		SUMMARY_STATION_ONE_YEAR.put(KEY_RESULT_COUNT, BigDecimal.valueOf(1));
		SUMMARY_STATION_ONE_YEAR.put(KEY_MONITORING_LOCATION_SUMMARY, "{\"characteristicType\": 1}");	
		SUMMARY_STATION_ONE_YEAR.put(KEY_STATE_NAME, "Hawaii");
		SUMMARY_STATION_ONE_YEAR.put(KEY_COUNTY_NAME, "Clay County");
		SUMMARY_STATION_ONE_YEAR.put(KEY_STATION_NAME, "Wintergreen ln");
	}
	
	public static final Map<String, Object> SUMMARY_STATION_FIVE_YEARS;
	static {
		SUMMARY_STATION_FIVE_YEARS = new LinkedHashMap<>();
		...
		SUMMARY_STATION_FIVE_YEARS.put(KEY_ORGANIZATION_NAME, "organization name");
		SUMMARY_STATION_FIVE_YEARS.put(KEY_SITE_TYPE, "siteType");
		SUMMARY_STATION_FIVE_YEARS.put(KEY_HUC_8, "00000000");
		SUMMARY_STATION_FIVE_YEARS.put(KEY_MONITORING_LOCATION_TYPE, "River/Stream");
		SUMMARY_STATION_FIVE_YEARS.put(KEY_LATITUDE, "43.3330000");
		SUMMARY_STATION_FIVE_YEARS.put(KEY_LONGITUDE, "-89.8989000");
		SUMMARY_STATION_FIVE_YEARS.put(KEY_ACTIVITY_COUNT, BigDecimal.valueOf(3));
		SUMMARY_STATION_FIVE_YEARS.put(KEY_RESULT_COUNT, BigDecimal.valueOf(3));
		SUMMARY_STATION_FIVE_YEARS.put(KEY_MONITORING_LOCATION_SUMMARY, "{\"characteristicType\": 3}");	
		SUMMARY_STATION_FIVE_YEARS.put(KEY_STATE_NAME, "Hawaii");
		SUMMARY_STATION_FIVE_YEARS.put(KEY_COUNTY_NAME, "Clay County");
		SUMMARY_STATION_FIVE_YEARS.put(KEY_STATION_NAME, "Wintergreen ln");
	}
	
	public static final Map<String, Object> SUMMARY_STATION_ALL_YEARS;
	static {
		SUMMARY_STATION_ALL_YEARS = new LinkedHashMap<>();
		...
		SUMMARY_STATION_ALL_YEARS.put(KEY_ORGANIZATION_NAME, "organization name");
		SUMMARY_STATION_ALL_YEARS.put(KEY_SITE_TYPE, "siteType");
		SUMMARY_STATION_ALL_YEARS.put(KEY_HUC_8, "00000000");
		SUMMARY_STATION_ALL_YEARS.put(KEY_MONITORING_LOCATION_TYPE, "River/Stream");
		...
		SUMMARY_STATION_ALL_YEARS.put(KEY_MONITORING_LOCATION_SUMMARY, "{\"characteristicType\": 4}");	
		SUMMARY_STATION_ALL_YEARS.put(KEY_STATE_NAME, "Hawaii");
		SUMMARY_STATION_ALL_YEARS.put(KEY_COUNTY_NAME, "Clay County");
		SUMMARY_STATION_ALL_YEARS.put(KEY_STATION_NAME, "Wintergreen ln");
	}
