...
public class TestSummaryStationMap {
	...
	static {
		...
		SUMMARY_STATION_ONE_YEAR.put(KEY_SUMMARY_PAST_12_MONTHS, "{\"characteristicType\": 1}");	
	...
	static {
		...
		SUMMARY_STATION_FIVE_YEARS.put(KEY_SUMMARY_PAST_60_MONTHS, "{\"characteristicType\": 3}");	
