...
public class CountDao extends BaseDao implements ICountDao {
	...
	@Override
	public List<Map<String, Object>> getCounts(NameSpace nameSpace, Map<String, Object> parameterMap) {
	...
	protected Map<String, Object> adjustMinCount(NameSpace nameSpace, Map<String, Object> parameterMap) {
		...
		Parameters adjustParameter = nameSpace.getAdjustParameter();
		if (null != adjustParameter && !adjustedParameterMap.containsKey(adjustParameter.toString())) {
			adjustedParameterMap.put(adjustParameter.toString(), new String[]{"1"});
		}
