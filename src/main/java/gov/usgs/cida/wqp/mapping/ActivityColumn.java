...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public static final ColumnProfile ACT_HORIZONTAL_COLLECT_METHOD = new ColumnProfile(KEY_ACT_HORIZONTAL_COLLECT_METHOD, Profile.BIOLOGICAL, Profile.ACTIVITY, Profile.ACTIVITY_ALL);
	public static final ColumnProfile ACT_HORIZONTAL_DATUM_NAME = new ColumnProfile(KEY_ACT_HORIZONTAL_DATUM_NAME, Profile.BIOLOGICAL, Profile.ACTIVITY, Profile.ACTIVITY_ALL);
	public static final ColumnProfile ASSEMBLAGE_SAMPLED_NAME = new ColumnProfile(KEY_ASSEMBLAGE_SAMPLED_NAME, Profile.BIOLOGICAL, Profile.ACTIVITY, Profile.ACTIVITY_ALL);
	public static final ColumnProfile ACT_COLLECTION_DURATION = new ColumnProfile(KEY_ACT_COLLECTION_DURATION, Profile.BIOLOGICAL, Profile.ACTIVITY, Profile.ACTIVITY_ALL);
	public static final ColumnProfile ACT_COLLECTION_DURATION_UNIT = new ColumnProfile(KEY_ACT_COLLECTION_DURATION_UNIT, Profile.BIOLOGICAL, Profile.ACTIVITY, Profile.ACTIVITY_ALL);
	public static final ColumnProfile ACT_SAM_COMPNT_NAME = new ColumnProfile(KEY_ACT_SAM_COMPNT_NAME, Profile.BIOLOGICAL, Profile.ACTIVITY, Profile.ACTIVITY_ALL);
	public static final ColumnProfile ACT_SAM_COMPNT_PLACE_IN_SERIES = new ColumnProfile(KEY_ACT_SAM_COMPNT_PLACE_IN_SERIES, Profile.BIOLOGICAL, Profile.ACTIVITY, Profile.ACTIVITY_ALL);
	public static final ColumnProfile ACT_REACH_LENGTH = new ColumnProfile(KEY_ACT_REACH_LENGTH, Profile.BIOLOGICAL, Profile.ACTIVITY, Profile.ACTIVITY_ALL);
	public static final ColumnProfile ACT_REACH_LENGTH_UNIT = new ColumnProfile(KEY_ACT_REACH_LENGTH_UNIT, Profile.BIOLOGICAL, Profile.ACTIVITY, Profile.ACTIVITY_ALL);
	public static final ColumnProfile ACT_REACH_WIDTH = new ColumnProfile(KEY_ACT_REACH_WIDTH, Profile.BIOLOGICAL, Profile.ACTIVITY, Profile.ACTIVITY_ALL);
	public static final ColumnProfile ACT_REACH_WIDTH_UNIT = new ColumnProfile(KEY_ACT_REACH_WIDTH_UNIT, Profile.BIOLOGICAL, Profile.ACTIVITY, Profile.ACTIVITY_ALL);
	public static final ColumnProfile ACT_PASS_COUNT = new ColumnProfile(KEY_ACT_PASS_COUNT, Profile.BIOLOGICAL, Profile.ACTIVITY, Profile.ACTIVITY_ALL);
	public static final ColumnProfile NET_TYPE_NAME = new ColumnProfile(KEY_NET_TYPE_NAME, Profile.BIOLOGICAL, Profile.ACTIVITY, Profile.ACTIVITY_ALL);
	public static final ColumnProfile ACT_NET_SURFACE_AREA = new ColumnProfile(KEY_ACT_NET_SURFACE_AREA, Profile.BIOLOGICAL, Profile.ACTIVITY, Profile.ACTIVITY_ALL);
	public static final ColumnProfile ACT_NET_SURFACE_AREA_UNIT = new ColumnProfile(KEY_ACT_NET_SURFACE_AREA_UNIT, Profile.BIOLOGICAL, Profile.ACTIVITY, Profile.ACTIVITY_ALL);
	public static final ColumnProfile ACT_NET_MESH_SIZE = new ColumnProfile(KEY_ACT_NET_MESH_SIZE, Profile.BIOLOGICAL, Profile.ACTIVITY, Profile.ACTIVITY_ALL);
	public static final ColumnProfile ACT_NET_MESH_SIZE_UNIT = new ColumnProfile(KEY_ACT_NET_MESH_SIZE_UNIT, Profile.BIOLOGICAL, Profile.ACTIVITY, Profile.ACTIVITY_ALL);
	public static final ColumnProfile ACT_BOAT_SPEED = new ColumnProfile(KEY_ACT_BOAT_SPEED, Profile.BIOLOGICAL, Profile.ACTIVITY, Profile.ACTIVITY_ALL);
	public static final ColumnProfile ACT_BOAT_SPEED_UNIT = new ColumnProfile(KEY_ACT_BOAT_SPEED_UNIT, Profile.BIOLOGICAL, Profile.ACTIVITY, Profile.ACTIVITY_ALL);
	...
	public static final ColumnProfile ACT_SAM_PREP_METH_NAME = new ColumnProfile(KEY_ACT_SAM_PREP_METH_NAME, Profile.BIOLOGICAL, Profile.ACTIVITY, Profile.ACTIVITY_ALL);
	public static final ColumnProfile ACT_SAM_PREP_METH_QUAL_TYPE = new ColumnProfile(KEY_ACT_SAM_PREP_METH_QUAL_TYPE, Profile.BIOLOGICAL, Profile.ACTIVITY, Profile.ACTIVITY_ALL);
	public static final ColumnProfile ACT_SAM_PREP_METH_DESC = new ColumnProfile(KEY_ACT_SAM_PREP_METH_DESC, Profile.BIOLOGICAL, Profile.ACTIVITY, Profile.ACTIVITY_ALL);
	public static final ColumnProfile SAMPLE_CONTAINER_TYPE = new ColumnProfile(KEY_SAMPLE_CONTAINER_TYPE, Profile.BIOLOGICAL, Profile.ACTIVITY, Profile.ACTIVITY_ALL);
	public static final ColumnProfile SAMPLE_CONTAINER_COLOR = new ColumnProfile(KEY_SAMPLE_CONTAINER_COLOR, Profile.BIOLOGICAL, Profile.ACTIVITY, Profile.ACTIVITY_ALL);
