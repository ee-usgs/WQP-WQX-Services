...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public static final ColumnProfile EXTERNAL_RESULT_ID = new ColumnProfile(KEY_EXTERNAL_RESULT_ID, Profile.NARROW_RESULT, Profile.RES_DETECT_QNT_LMT, Profile.RESULT_PHYS_CHEM);
	...
	public static final ColumnProfile RESULT_DETECTION_CONDITION_TX = new ColumnProfile(KEY_RESULT_DETECTION_CONDITION_TX, Profile.BIOLOGICAL, Profile.PC_RESULT, Profile.NARROW_RESULT, Profile.RESULT_PHYS_CHEM);

	//Note that "SPECIATION" is correct and "SPECIFICATION" is a typo.
	public static final ColumnProfile METHOD_SPECIATION_NAME = new ColumnProfile(KEY_METHOD_SPECIATION_NAME, Profile.RESULT_PHYS_CHEM);
	...
	public static final ColumnProfile CHARACTERISTIC_NAME = new ColumnProfile(KEY_CHARACTERISTIC_NAME, Profile.BIOLOGICAL, Profile.PC_RESULT, Profile.RES_DETECT_QNT_LMT, Profile.NARROW_RESULT, Profile.RESULT_PHYS_CHEM);
	...
	public static final ColumnProfile RESULT_DEPTH_MEAS_UNIT_CODE = new ColumnProfile(KEY_RESULT_DEPTH_MEAS_UNIT_CODE, Profile.BIOLOGICAL, Profile.PC_RESULT, Profile.NARROW_RESULT, Profile.RESULT_PHYS_CHEM);
	public static final ColumnProfile RESULT_DEPTH_ALT_REF_PT_TXT = new ColumnProfile(KEY_RESULT_DEPTH_ALT_REF_PT_TXT, Profile.BIOLOGICAL, Profile.PC_RESULT, Profile.NARROW_RESULT, Profile.RESULT_PHYS_CHEM);
	public static final ColumnProfile RES_SAMPLING_POINT_NAME = new ColumnProfile(KEY_RES_SAMPLING_POINT_NAME, Profile.BIOLOGICAL, Profile.NARROW_RESULT);
	public static final ColumnProfile BIOLOGICAL_INTENT = new ColumnProfile(KEY_BIOLOGICAL_INTENT, Profile.BIOLOGICAL, Profile.NARROW_RESULT);
	public static final ColumnProfile RES_BIO_INDIVIDUAL_ID = new ColumnProfile(KEY_RES_BIO_INDIVIDUAL_ID, Profile.BIOLOGICAL, Profile.NARROW_RESULT);
	public static final ColumnProfile SAMPLE_TISSUE_TAXONOMIC_NAME = new ColumnProfile(KEY_SAMPLE_TISSUE_TAXONOMIC_NAME, Profile.BIOLOGICAL, Profile.PC_RESULT, Profile.NARROW_RESULT, Profile.RESULT_PHYS_CHEM);
	public static final ColumnProfile UNIDENTIFIEDSPECIESIDENTIFIER = new ColumnProfile(KEY_UNIDENTIFIEDSPECIESIDENTIFIER, Profile.BIOLOGICAL, Profile.NARROW_RESULT);
	public static final ColumnProfile SAMPLE_TISSUE_ANATOMY_NAME = new ColumnProfile(KEY_SAMPLE_TISSUE_ANATOMY_NAME, Profile.BIOLOGICAL, Profile.PC_RESULT, Profile.NARROW_RESULT, Profile.RESULT_PHYS_CHEM);
	public static final ColumnProfile RES_GROUP_SUMMARY_CT_WT = new ColumnProfile(KEY_RES_GROUP_SUMMARY_CT_WT, Profile.BIOLOGICAL, Profile.NARROW_RESULT);
	public static final ColumnProfile RES_GROUP_SUMMARY_CT_WT_UNIT = new ColumnProfile(KEY_RES_GROUP_SUMMARY_CT_WT_UNIT, Profile.BIOLOGICAL, Profile.NARROW_RESULT);
	public static final ColumnProfile CELL_FORM_NAME = new ColumnProfile(KEY_CELL_FORM_NAME, Profile.BIOLOGICAL, Profile.NARROW_RESULT);
	public static final ColumnProfile CELL_SHAPE_NAME = new ColumnProfile(KEY_CELL_SHAPE_NAME, Profile.BIOLOGICAL, Profile.NARROW_RESULT);
	public static final ColumnProfile HABIT_NAME = new ColumnProfile(KEY_HABIT_NAME, Profile.BIOLOGICAL, Profile.NARROW_RESULT);
	public static final ColumnProfile VOLT_NAME = new ColumnProfile(KEY_VOLT_NAME, Profile.BIOLOGICAL, Profile.NARROW_RESULT);
	public static final ColumnProfile RTDET_POLLUTION_TOLERANCE = new ColumnProfile(KEY_RTDET_POLLUTION_TOLERANCE, Profile.BIOLOGICAL, Profile.NARROW_RESULT);
	public static final ColumnProfile RTDET_POLLUTION_TOLERNCE_SCALE = new ColumnProfile(KEY_RTDET_POLLUTION_TOLERNCE_SCALE, Profile.BIOLOGICAL, Profile.NARROW_RESULT);
	public static final ColumnProfile RTDET_TROPHIC_LEVEL = new ColumnProfile(KEY_RTDET_TROPHIC_LEVEL, Profile.BIOLOGICAL, Profile.NARROW_RESULT);
	public static final ColumnProfile RTFGRP_FUNCTIONAL_FEEDING_GRP = new ColumnProfile(KEY_RTFGRP_FUNCTIONAL_FEEDING_GRP, Profile.BIOLOGICAL, Profile.NARROW_RESULT);
	public static final ColumnProfile TAXON_CITATION_TITLE = new ColumnProfile(KEY_TAXON_CITATION_TITLE, Profile.BIOLOGICAL, Profile.NARROW_RESULT);
	public static final ColumnProfile TAXON_CITATION_CREATOR = new ColumnProfile(KEY_TAXON_CITATION_CREATOR, Profile.BIOLOGICAL, Profile.NARROW_RESULT);
	public static final ColumnProfile TAXON_CITATION_SUBJECT = new ColumnProfile(KEY_TAXON_CITATION_SUBJECT, Profile.BIOLOGICAL, Profile.NARROW_RESULT);
	public static final ColumnProfile TAXON_CITATION_PUBLISHER = new ColumnProfile(KEY_TAXON_CITATION_PUBLISHER, Profile.BIOLOGICAL, Profile.NARROW_RESULT);
	public static final ColumnProfile TAXON_CITATION_DATE = new ColumnProfile(KEY_TAXON_CITATION_DATE, Profile.BIOLOGICAL, Profile.NARROW_RESULT);
	public static final ColumnProfile TAXON_CITATION_ID = new ColumnProfile(KEY_TAXON_CITATION_ID, Profile.BIOLOGICAL, Profile.NARROW_RESULT);
	...
	public static final ColumnProfile METHOD_URL = new ColumnProfile(KEY_METHOD_URL, Profile.NARROW_RESULT, Profile.RESULT_PHYS_CHEM);
	public static final ColumnProfile ANALYTICAL_PROCEDURE_ID = new ColumnProfile(KEY_ANALYTICAL_PROCEDURE_ID, Profile.BIOLOGICAL, Profile.PC_RESULT, Profile.NARROW_RESULT, Profile.RESULT_PHYS_CHEM);
	...
	public static final ColumnProfile ANALYSIS_START_TIMEZONE = new ColumnProfile(KEY_ANALYSIS_START_TIMEZONE, Profile.BIOLOGICAL, Profile.NARROW_RESULT);
	public static final ColumnProfile ANALYSIS_END_DATE = new ColumnProfile(KEY_ANALYSIS_END_DATE, Profile.BIOLOGICAL, Profile.NARROW_RESULT);
	public static final ColumnProfile ANALYSIS_END_TIME = new ColumnProfile(KEY_ANALYSIS_END_TIME, Profile.BIOLOGICAL, Profile.NARROW_RESULT);
	public static final ColumnProfile ANALYSIS_END_TIMEZONE = new ColumnProfile(KEY_ANALYSIS_END_TIMEZONE, Profile.BIOLOGICAL, Profile.NARROW_RESULT);
	public static final ColumnProfile RLCOM_CD = new ColumnProfile(KEY_RLCOM_CD, Profile.BIOLOGICAL, Profile.NARROW_RESULT);
	...
	public static final ColumnProfile RES_DETECT_QNT_LMT_URL = new ColumnProfile(KEY_RES_DETECT_QNT_LMT_URL, Profile.NARROW_RESULT, Profile.RESULT_PHYS_CHEM);
	public static final ColumnProfile DETECTION_LIMIT_DESC = new ColumnProfile(KEY_DETECTION_LIMIT_DESC, Profile.BIOLOGICAL, Profile.PC_RESULT, Profile.RES_DETECT_QNT_LMT, Profile.RESULT_PHYS_CHEM);
	public static final ColumnProfile DETECTION_LIMIT = new ColumnProfile(KEY_DETECTION_LIMIT, Profile.BIOLOGICAL, Profile.PC_RESULT, Profile.RES_DETECT_QNT_LMT, Profile.RESULT_PHYS_CHEM);
	public static final ColumnProfile DETECTION_LIMIT_UNIT = new ColumnProfile(KEY_DETECTION_LIMIT_UNIT, Profile.BIOLOGICAL, Profile.PC_RESULT, Profile.RES_DETECT_QNT_LMT, Profile.RESULT_PHYS_CHEM);
	public static final ColumnProfile RES_LAB_ACCRED_YN = new ColumnProfile(KEY_RES_LAB_ACCRED_YN, Profile.BIOLOGICAL, Profile.NARROW_RESULT);
	public static final ColumnProfile RES_LAB_ACCRED_AUTHORITY = new ColumnProfile(KEY_RES_LAB_ACCRED_AUTHORITY, Profile.BIOLOGICAL, Profile.NARROW_RESULT);
	public static final ColumnProfile RES_TAXONOMIST_ACCRED_YN = new ColumnProfile(KEY_RES_TAXONOMIST_ACCRED_YN, Profile.BIOLOGICAL, Profile.NARROW_RESULT);
	public static final ColumnProfile RES_TAXONOMIST_ACCRED_AUTHORTY = new ColumnProfile(KEY_RES_TAXONOMIST_ACCRED_AUTHORTY, Profile.BIOLOGICAL, Profile.NARROW_RESULT);
	...
	public static final ColumnProfile LAB_SAMPLE_PREP_URL = new ColumnProfile(KEY_LAB_SAMPLE_PREP_URL,Profile.NARROW_RESULT, Profile.RESULT_PHYS_CHEM);
	public static final ColumnProfile RESULT_OBJECT_NAME = new ColumnProfile(KEY_RESULT_OBJECT_NAME, Profile.RESULT_PHYS_CHEM);
	public static final ColumnProfile RESULT_OBJECT_TYPE = new ColumnProfile(KEY_RESULT_OBJECT_TYPE, Profile.RESULT_PHYS_CHEM);
