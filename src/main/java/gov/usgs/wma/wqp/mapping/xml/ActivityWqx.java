...
public class ActivityWqx extends BaseWqx implements IXmlMapping {
	...
	static {
		...
		COLUMN_POSITION.put(KEY_ACTIVITY_OBJECT_NAME,
				new LinkedList<String>(Arrays.asList(
						WQX_ACTIVITY,
						WQX_ACT_ATTACHMENT,
						WQX_FILE_NAME)));
		COLUMN_POSITION.put(KEY_ACTIVITY_OBJECT_TYPE,
				new LinkedList<String>(Arrays.asList(
						WQX_ACTIVITY,
						WQX_ACT_ATTACHMENT,
						WQX_FILE_TYPE)));
		COLUMN_POSITION.put(KEY_ACTIVITY_FILE_URL,
				new LinkedList<String>(Arrays.asList(
						WQX_ACTIVITY,
						WQX_ACT_ATTACHMENT,
		...
		COLUMN_POSITION.put(KEY_ACTIVITY_GROUP_URL,
				new LinkedList<String>(Arrays.asList(
						WQX_ACTIVITY,
						WQX_ACTIVITY_GROUP_URL)));
	}
