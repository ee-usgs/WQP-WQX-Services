...
import static gov.usgs.wma.wqp.mapping.StationColumn.AQFR_NAME;
import static gov.usgs.wma.wqp.mapping.StationColumn.AQFR_TYPE_NAME;
import static gov.usgs.wma.wqp.mapping.StationColumn.CONTRIB_DRAIN_AREA_UNIT;
import static gov.usgs.wma.wqp.mapping.StationColumn.CONTRIB_DRAIN_AREA_VALUE;
import static gov.usgs.wma.wqp.mapping.StationColumn.HUC_8;
import static gov.usgs.wma.wqp.mapping.StationColumn.KEY_AQFR_NAME;
import static gov.usgs.wma.wqp.mapping.StationColumn.KEY_AQFR_TYPE_NAME;
import static gov.usgs.wma.wqp.mapping.StationColumn.KEY_CONTRIB_DRAIN_AREA_UNIT;
import static gov.usgs.wma.wqp.mapping.StationColumn.KEY_CONTRIB_DRAIN_AREA_VALUE;
import static gov.usgs.wma.wqp.mapping.StationColumn.KEY_HUC_8;
import static gov.usgs.wma.wqp.mapping.StationColumn.KEY_MONITORING_LOCATION_DESCRIPTION;
import static gov.usgs.wma.wqp.mapping.StationColumn.KEY_MONITORING_LOCATION_TYPE;
import static gov.usgs.wma.wqp.mapping.StationColumn.KEY_STATION_NAME;
import static gov.usgs.wma.wqp.mapping.StationColumn.KEY_WELL_DEPTH_UNIT;
import static gov.usgs.wma.wqp.mapping.StationColumn.KEY_WELL_DEPTH_VALUE;
import static gov.usgs.wma.wqp.mapping.StationColumn.MONITORING_LOCATION_DESCRIPTION;
...
import static gov.usgs.wma.wqp.mapping.StationColumn.WELL_DEPTH_UNIT;
import static gov.usgs.wma.wqp.mapping.StationColumn.WELL_DEPTH_VALUE;
