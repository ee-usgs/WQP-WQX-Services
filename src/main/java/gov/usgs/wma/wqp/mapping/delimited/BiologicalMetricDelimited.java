...
import static gov.usgs.wma.wqp.mapping.BaseColumn.DATA_SOURCE;
...
import static gov.usgs.wma.wqp.mapping.xml.BaseWqx.WQX_INDEX_CALCULATED_DATE;
import static gov.usgs.wma.wqp.mapping.xml.BaseWqx.WQX_INDEX_COMMENT_TEXT;
import static gov.usgs.wma.wqp.mapping.xml.BaseWqx.WQX_INDEX_ID;
import static gov.usgs.wma.wqp.mapping.xml.BaseWqx.WQX_INDEX_QUALIFIER_CODE;
import static gov.usgs.wma.wqp.mapping.xml.BaseWqx.WQX_INDEX_SCORE_NUMERIC;
import static gov.usgs.wma.wqp.mapping.xml.BaseWqx.WQX_INDEX_TYPE_IDENTIFER;
import static gov.usgs.wma.wqp.mapping.xml.BaseWqx.WQX_INDEX_TYPE_IDENTIFER_CONTEXT;
import static gov.usgs.wma.wqp.mapping.xml.BaseWqx.WQX_INDEX_TYPE_NAME;
import static gov.usgs.wma.wqp.mapping.xml.BaseWqx.WQX_INDEX_TYPE_SCALE_TEXT;
import static gov.usgs.wma.wqp.mapping.xml.BaseWqx.WQX_PROVIDER_NAME;
import static gov.usgs.wma.wqp.mapping.xml.BaseWqx.WQX_RESOURCE_CREATOR;
import static gov.usgs.wma.wqp.mapping.xml.BaseWqx.WQX_RESOURCE_DATE;
import static gov.usgs.wma.wqp.mapping.xml.BaseWqx.WQX_RESOURCE_ID;
import static gov.usgs.wma.wqp.mapping.xml.BaseWqx.WQX_RESOURCE_PUBLISHER;
import static gov.usgs.wma.wqp.mapping.xml.BaseWqx.WQX_RESOURCE_SUBJECT;
import static gov.usgs.wma.wqp.mapping.xml.BaseWqx.WQX_RESOURCE_TITLE;
