...
public class ResultDelimited extends BaseDelimited {
	...
	public static final String VALUE_METHOD_SPECIATION_NAME = WQX_METHOD_SPECIATION;
	...
	public static final String VALUE_DQ_PRECISION = WQX_DATA_QUALITY + VAL_DEL + WQX_PRECISION;
	...
	public static final String VALUE_DQ_RES_MEASURE_CONF_INTERVAL = WQX_DATA_QUALITY + VAL_DEL + WQX_CONFIDENCE_INTERVAL;
	public static final String VALUE_RES_MEASURE_UPPER_CONF_LIMIT = WQX_UPPER_CONFIDENCE_LIMIT;
	public static final String VALUE_DQ_RES_MEASURE_UPPER_CONF_LIMIT = WQX_DATA_QUALITY + VAL_DEL + WQX_UPPER_CONFIDENCE_LIMIT;
	public static final String VALUE_RES_MEASURE_LOWER_CONF_LIMIT = WQX_LOWER_CONFIDENCE_LIMIT;
	public static final String VALUE_DQ_RES_MEASURE_LOWER_CONF_LIMIT = WQX_DATA_QUALITY + VAL_DEL + WQX_LOWER_CONFIDENCE_LIMIT;
	...
	public static final String VALUE_VOLTINISM_NAME = WQX_VOLTINISM;
	...
	public static final String VALUE_FCDSC_URL = WQX_FREQUENCY_CLASS_INFO_URL;
	public static final String VALUE_FCDSC_NAME = WQX_FREQUENCY_CLASS_DESCRIPTOR;
	public static final String VALUE_FREQUENCY_CLASS_CODE_1 = WQX_FREQUENCY_CLASS_INFO + VAL_DEL + WQX_FREQUENCY_CLASS_DESCRIPTOR + "_1";
	public static final String VALUE_FREQUENCY_CLASS_CODE_2 = WQX_FREQUENCY_CLASS_INFO + VAL_DEL + WQX_FREQUENCY_CLASS_DESCRIPTOR + "_2";
	public static final String VALUE_FREQUENCY_CLASS_CODE_3 = WQX_FREQUENCY_CLASS_INFO + VAL_DEL + WQX_FREQUENCY_CLASS_DESCRIPTOR + "_3";
	public static final String VALUE_FREQUENCY_CLASS_UNIT = WQX_FREQUENCE_CLASS_DESCRIPTOR_UNIT;
	public static final String VALUE_FREQUENCY_CLASS_UNIT_1 = WQX_FREQUENCY_CLASS_INFO + VAL_DEL + WQX_FREQUENCE_CLASS_DESCRIPTOR_UNIT + "_1";
	public static final String VALUE_FREQUENCY_CLASS_UNIT_2 = WQX_FREQUENCY_CLASS_INFO + VAL_DEL + WQX_FREQUENCE_CLASS_DESCRIPTOR_UNIT + "_2";
	public static final String VALUE_FREQUENCY_CLASS_UNIT_3 = WQX_FREQUENCY_CLASS_INFO + VAL_DEL + WQX_FREQUENCE_CLASS_DESCRIPTOR_UNIT + "_3";
	public static final String VALUE_FCDSC_LOWER_BOUND = WQX_LOWER_CLASS_BOUND;
	public static final String VALUE_FREQUENCY_CLASS_LOWER_BOUND_1 = WQX_FREQUENCY_CLASS_INFO + VAL_DEL + WQX_LOWER_CLASS_BOUND + "_1";
	public static final String VALUE_FREQUENCY_CLASS_LOWER_BOUND_2 = WQX_FREQUENCY_CLASS_INFO + VAL_DEL + WQX_LOWER_CLASS_BOUND + "_2";
	public static final String VALUE_FREQUENCY_CLASS_LOWER_BOUND_3 = WQX_FREQUENCY_CLASS_INFO + VAL_DEL + WQX_LOWER_CLASS_BOUND + "_3";
	public static final String VALUE_FCDSC_UPPER_BOUND = WQX_UPPER_CLASS_BOUND;
	public static final String VALUE_FREQUENCY_CLASS_UPPER_BOUND_1 = WQX_FREQUENCY_CLASS_INFO + VAL_DEL + WQX_UPPER_CLASS_BOUND + "_1";
	public static final String VALUE_FREQUENCY_CLASS_UPPER_BOUND_2 = WQX_FREQUENCY_CLASS_INFO + VAL_DEL + WQX_UPPER_CLASS_BOUND + "_2";
	public static final String VALUE_FREQUENCY_CLASS_UPPER_BOUND_3 = WQX_FREQUENCY_CLASS_INFO + VAL_DEL + WQX_UPPER_CLASS_BOUND + "_3";

	public static final String VALUE_RESULT_OBJECT_NAME = WQX_FILE_NAME;
	public static final String VALUE_RESULT_OBJECT_TYPE = WQX_FILE_TYPE;
	public static final String VALUE_RESULT_FILE_URL = WQX_RESULT_FILE_URL;

	public static final String VALUE_METHOD_URL = WQX_ANALYTICAL_METHOD + VAL_DEL + WQX_METHOD_URL;
	...
	public static final String VALUE_R_ANALYTICAL_METHOD_CITATION = WQX_ANALYTICAL_METHOD + VAL_DEL + WQX_METHOD_DESCRIPTION;
	...
	public static final String VALUE_DETECTION_LIMIT_URL = WQX_DETECTION_LIMIT_URL;
	...
	public static final String VALUE_LAB_SAMPLE_PREP_URL = WQX_LAB_SAMPLE_PREP_URL;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	static {
		...
		MAPPINGS.put(EXTERNAL_RESULT_ID, VALUE_RESULT_IDENTIFIER);
		...
		//Note that "SPECIATION" is correct and "SPECIFICATION" is a typo.
		MAPPINGS.put(METHOD_SPECIATION_NAME, VALUE_METHOD_SPECIATION_NAME);
		...
		MAPPINGS.put(DQ_PRECISION, VALUE_DQ_PRECISION);
		...
		MAPPINGS.put(DQ_RES_MEASURE_CONF_INTERVAL, VALUE_DQ_RES_MEASURE_CONF_INTERVAL);
		MAPPINGS.put(RES_MEASURE_UPPER_CONF_LIMIT, VALUE_RES_MEASURE_UPPER_CONF_LIMIT);
		MAPPINGS.put(DQ_RES_MEASURE_UPPER_CONF_LIMIT, VALUE_DQ_RES_MEASURE_UPPER_CONF_LIMIT);
		MAPPINGS.put(RES_MEASURE_LOWER_CONF_LIMIT, VALUE_RES_MEASURE_LOWER_CONF_LIMIT);
		MAPPINGS.put(DQ_RES_MEASURE_LOWER_CONF_LIMIT, VALUE_DQ_RES_MEASURE_LOWER_CONF_LIMIT);
		...
		MAPPINGS.put(VOLTINISM_NAME, VALUE_VOLTINISM_NAME);
		...
		//Split into 3 columns for each value in newer profiles.
		MAPPINGS.put(FCDSC_URL, VALUE_FCDSC_URL);
		MAPPINGS.put(FCDSC_NAME, VALUE_FCDSC_NAME);
		MAPPINGS.put(FREQUENCY_CLASS_CODE_1, VALUE_FREQUENCY_CLASS_CODE_1);
		MAPPINGS.put(FREQUENCY_CLASS_CODE_2, VALUE_FREQUENCY_CLASS_CODE_2);
		MAPPINGS.put(FREQUENCY_CLASS_CODE_3, VALUE_FREQUENCY_CLASS_CODE_3);
		MAPPINGS.put(FREQUENCY_CLASS_UNIT, VALUE_FREQUENCY_CLASS_UNIT);
		MAPPINGS.put(FREQUENCY_CLASS_UNIT_1, VALUE_FREQUENCY_CLASS_UNIT_1);
		MAPPINGS.put(FREQUENCY_CLASS_UNIT_2, VALUE_FREQUENCY_CLASS_UNIT_2);
		MAPPINGS.put(FREQUENCY_CLASS_UNIT_3, VALUE_FREQUENCY_CLASS_UNIT_3);
		MAPPINGS.put(FCDSC_LOWER_BOUND, VALUE_FCDSC_LOWER_BOUND);
		MAPPINGS.put(FREQUENCY_CLASS_LOWER_BOUND_1, VALUE_FREQUENCY_CLASS_LOWER_BOUND_1);
		MAPPINGS.put(FREQUENCY_CLASS_LOWER_BOUND_2, VALUE_FREQUENCY_CLASS_LOWER_BOUND_2);
		MAPPINGS.put(FREQUENCY_CLASS_LOWER_BOUND_3, VALUE_FREQUENCY_CLASS_LOWER_BOUND_3);
		MAPPINGS.put(FCDSC_UPPER_BOUND, VALUE_FCDSC_UPPER_BOUND);
		MAPPINGS.put(FREQUENCY_CLASS_UPPER_BOUND_1, VALUE_FREQUENCY_CLASS_UPPER_BOUND_1);
		MAPPINGS.put(FREQUENCY_CLASS_UPPER_BOUND_2, VALUE_FREQUENCY_CLASS_UPPER_BOUND_2);
		MAPPINGS.put(FREQUENCY_CLASS_UPPER_BOUND_3, VALUE_FREQUENCY_CLASS_UPPER_BOUND_3);

		MAPPINGS.put(RESULT_OBJECT_NAME, VALUE_RESULT_OBJECT_NAME);
		MAPPINGS.put(RESULT_OBJECT_TYPE, VALUE_RESULT_OBJECT_TYPE);
		MAPPINGS.put(RESULT_FILE_URL, VALUE_RESULT_FILE_URL);
		...
		MAPPINGS.put(METHOD_URL, VALUE_METHOD_URL);
		...
		MAPPINGS.put(R_ANALYTICAL_METHOD_CITATION, VALUE_R_ANALYTICAL_METHOD_CITATION);
		...
		MAPPINGS.put(RES_DETECT_QNT_LMT_URL, VALUE_DETECTION_LIMIT_URL);
		...
		MAPPINGS.put(LAB_SAMPLE_PREP_URL, VALUE_LAB_SAMPLE_PREP_URL);
		...
		MAPPINGS.put(EXTERNAL_RESULT_ID, VALUE_RESULT_IDENTIFIER);
		MAPPINGS.put(LAST_UPDATED, VALUE_LAST_UPDATED);
